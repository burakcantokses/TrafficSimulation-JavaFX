...
public class Building {
    ...
    public Node toNode() {
        ...
        switch (type) {
            ...
            case 1:
                return createBuildingCircle(x, y, cellSize, color);
            case 2:
    ...
    private Group createType0Building(int x, int y, int cellSize, int rotation, int color) {
        ...
        double innerSize = cellSize * 2 * 0.9;
        ...
        innerRectangle.setStrokeType(StrokeType.INSIDE); // Set the stroke type
        ...
        Group group = new Group(mainRectangle, innerRectangle);
    ...
    public Circle createBuildingCircle(int x, int y, int cellSize, int color) {
